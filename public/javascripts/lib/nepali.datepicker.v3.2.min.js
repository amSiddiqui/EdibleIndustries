var NepaliFunctions = function () {
    ...
    function e() {
        ...
        function n(t, n) {
            ...
            for (r += s[t.year][11], a = n.month - 1; a < 12; a += 1) r -= s[n.year][a];
        ...
        function i(e, t) {
            for (e.day += t; e.day > s[e.year][e.month - 1];) e.day -= s[e.year][e.month - 1], e.month += 1, e.month > 12 && (e.month = 1, e.year += 1);
            return {
                year: e.year,
                month: e.month,
                day: e.day
    ...
    function H(e, t) {
        ...
        for (p = p.toString(), p = p.substring(0, p.length - 11), p > 0 && (r += n(p) + " Kharab"), m > 0 && (r += " " + n(m) + " Arab"), c > 0 && (r += " " + n(c) + " Crore"), l > 0 && (r += " " + n(l) + " Lakh"), s > 0 && (r += " " + n(s) + " Thousand"), u > 0 && (r += " " + n(u) + " Hundred"), d > 0 && (r += " " + n(d)), "" != r.trim() && t && (r += " Rupees"), a > 0 && t && (r += " and " + n(a) + " Paisa"); r.indexOf("  ") > -1;) r = r.replace("  ", " ");
        return r.trim()
    }
...
! function () {
    ...
    function i(e) {
        ...
        if (B) a("showNdpCalendarBox");
            ...
            var i = "";
            if (r) i = NepaliFunctions.ConvertToDateObject(r, t.dateFormat);
            else if (i = NepaliFunctions.GetCurrentBsDate(), t.disableAfter) {
    ...
    Object.prototype.nepaliDatePicker = function (e) {
        ...
        if ("remove" != e) {
            ...
            if (h.length > 0)
                for (var y = 0; y < h.length; y++) h[y].addEventListener("mouseenter", n), h[y].addEventListener("mouseleave", r);
